...
3. Вrite a program wchick assigns to the whole variable k the number of the quadrant in which the point P(x, y) is located.
...
11. Write a function which counts words in char* text. A "word" is defined to be a single or a sequence of characters diferent from 
